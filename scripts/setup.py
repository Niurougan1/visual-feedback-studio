    ...
    try:
        ...
        payload = {
            ...
            "extension": {
                ...
                "dev_manifest_template": str(ext / "manifest.dev.json"),
                ...
                "dev_unpacked_note": "manifest.dev.json documents the broad-permission development template; the store package uses manifest.json.",
            ...
            "source_mapping_notes": [
                ...
                "Run the benchmark command after source-mapping changes to confirm auto_misapply_count stays 0.",
            ],
            "commands": {
                ...
                "benchmark": " ".join(shlex.quote(part) for part in ["python3", str(runtime_dir / "scripts" / "benchmark_source_mapping.py")]),
